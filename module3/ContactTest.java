...
public class ContactTest { 
  ...
  @Test
  void constructor_createsIndependentObjects() {
    Contact c = new Contact("Alan Turing", "555-0001");
    Contact d = new Contact("Alan Turing", "555-0002");
    c = new Contact("Bob Smith", "555-0003");
    assertTrue(d.toString().contains("Alan Turing"));
  }
} 